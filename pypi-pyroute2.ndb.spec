...
%prep
%setup -q -n pyroute2.ndb-0.6.13
cd %{_builddir}/pyroute2.ndb-0.6.13
pushd ..
cp -a pyroute2.ndb-0.6.13 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707135093
...
cp %{_builddir}/pyroute2.ndb-%{version}/LICENSE.Apache.v2 %{buildroot}/usr/share/package-licenses/pypi-pyroute2.ndb/cd9bad64b174708395f795bb92f7b4be7d996e8f || :
cp %{_builddir}/pyroute2.ndb-%{version}/LICENSE.GPL.v2 %{buildroot}/usr/share/package-licenses/pypi-pyroute2.ndb/4cc77b90af91e615a64ae04893fdffa7939db84c || :
