...
Source0  : https://files.pythonhosted.org/packages/9f/67/833d11fbdc4828fb613345501802829f34028cb8a8c18e4b2cae2fb18302/pyroute2.ndb-0.6.11.tar.gz
...
%prep
%setup -q -n pyroute2.ndb-0.6.11
cd %{_builddir}/pyroute2.ndb-0.6.11
pushd ..
cp -a pyroute2.ndb-0.6.11 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1654547559
...
cp %{_builddir}/pyroute2.ndb-0.6.11/LICENSE.Apache.v2 %{buildroot}/usr/share/package-licenses/pypi-pyroute2.ndb/cd9bad64b174708395f795bb92f7b4be7d996e8f
cp %{_builddir}/pyroute2.ndb-0.6.11/LICENSE.GPL.v2 %{buildroot}/usr/share/package-licenses/pypi-pyroute2.ndb/4cc77b90af91e615a64ae04893fdffa7939db84c
