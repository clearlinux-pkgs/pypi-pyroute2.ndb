...
Source0  : https://files.pythonhosted.org/packages/fa/3e/24981b750043dfbdc2e08f11a5b083cafbfbf33ba6d3d466e76eb6344ef9/pyroute2.ndb-0.6.10.tar.gz
...
%prep
%setup -q -n pyroute2.ndb-0.6.10
cd %{_builddir}/pyroute2.ndb-0.6.10
pushd ..
cp -a pyroute2.ndb-0.6.10 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1654528488
...
cp %{_builddir}/pyroute2.ndb-0.6.10/LICENSE.Apache.v2 %{buildroot}/usr/share/package-licenses/pypi-pyroute2.ndb/cd9bad64b174708395f795bb92f7b4be7d996e8f
cp %{_builddir}/pyroute2.ndb-0.6.10/LICENSE.GPL.v2 %{buildroot}/usr/share/package-licenses/pypi-pyroute2.ndb/4cc77b90af91e615a64ae04893fdffa7939db84c
